package arkanoid_game.develop; //импортируем библиотеку

import java.awt.*;


//создаём класс levels
public class Levels {
    //переменая отвечающая за уровень проходящий на данный момент
    public static int current_level = 1;
    //количество уровней
    public int row_num = 4;
    //счётчик на каком ты уровне
    ...
    //стартовая позиция всех обьектов
    ...
    //далее идёт создание всех уровней
    void createLevel() {
    ...
    void drawLevel(int i) {
        // Создаем уровни, каждый уровень имеет совю корфигурацию
